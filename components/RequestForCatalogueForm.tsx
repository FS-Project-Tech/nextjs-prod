...
const schema = yup.object({
  ...
  number_of_copies: yup
    ...
    .required("Required"),
  address: yup.string().trim().min(5, "Please enter your full address").required("Address is required"),
    ...
    >
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div>
          ...
          <input id="first_name" type="text" className={inputClass} placeholder="First name" {...register("first_name")} />
        ...
        <div>
          ...
          <input id="last_name" type="text" className={inputClass} placeholder="Last name" {...register("last_name")} />
        ...
        <div>
          ...
          <input id="email" type="email" autoComplete="email" className={inputClass} placeholder="Email address" {...register("email")} />
        ...
        <div>
          ...
          <input id="reason_for_ordering" type="text" className={inputClass} placeholder="Reason for ordering" {...register("reason_for_ordering")} />
          {errors.reason_for_ordering && <p className={errClass}>{errors.reason_for_ordering.message}</p>}
        </div>
        ...
        <div>
          ...
          <input id="business_name" type="text" className={inputClass} placeholder="Business name" {...register("business_name")} />
        ...
        <div>
          ...
          <input id="abn" type="text" inputMode="numeric" className={inputClass} placeholder="ABN (11 digits, optional)" {...register("abn")} />
        ...
        <div>
          ...
          <input id="contact_number" type="tel" autoComplete="tel" className={inputClass} placeholder="Contact number" {...register("contact_number")} />
        ...
        <div>
          ...
          <input id="number_of_copies" type="number" min={1} max={500} className={inputClass} {...register("number_of_copies")} />
      ...
      <div className="mt-6">
        ...
        <textarea id="address" rows={4} className={inputClass} placeholder="Street, suburb, state, postcode" {...register("address")} />
