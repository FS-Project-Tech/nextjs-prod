...
export default function RegisterForm() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      else if (!isValidName(firstName)) errs.firstName = "Letters, spaces, hyphens and apostrophes only";
      if (!lastName) errs.lastName = "Last name is required";
      else if (!isValidName(lastName)) errs.lastName = "Letters, spaces, hyphens and apostrophes only";
          ...
          <div>
            <label className="text-sm font-medium text-slate-700">
              ...
              <input
                ...
                onInput={(e) => { e.currentTarget.value = nameCharsOnly(e.currentTarget.value); }}
