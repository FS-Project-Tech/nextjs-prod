    ...
    <div className="min-h-[50vh] bg-white">
      <div className="container mx-auto max-w-lg px-4 py-16 text-center">
        ...
        <h1 className="mt-2 text-2xl font-bold text-gray-900">
          Nursing service page not found
        </h1>
        ...
        <ul className="mt-3 list-disc pl-5 text-left text-sm text-gray-600">
          <li>
            ...
            <code className="rounded bg-gray-100 px-1">NEXT_PUBLIC_WP_URL</code>{" "}
            in <code className="rounded bg-gray-100 px-1">.env.local</code>, or
            ensure <code className="rounded bg-gray-100 px-1">WC_API_URL</code>{" "}
            points at your WordPress site (same host as the REST API).
          </li>
          <li>
            <strong>Published page</strong> — a WordPress <strong>Page</strong>{" "}
            exists with the same slug as this URL (e.g.{" "}
            <code className="rounded bg-gray-100 px-1">wound-management</code>),
