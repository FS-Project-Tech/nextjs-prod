...
/**
 * Vimeo embeds.
 * `player.vimeo.com` is the iframe host; include `vimeo.com` for related embed flows.
 */
const VIMEO_FRAME_SRC = "https://player.vimeo.com https://vimeo.com https://*.vimeo.com";
...
export const CSP_HEADER = [
  ...
  `frame-src *.google.com ${TAWK_FRAME_SRC} ${ACCESSIBE_FRAME_SRC} ${VERCEL_LIVE_FRAME_SRC} ${VIMEO_FRAME_SRC}`,
